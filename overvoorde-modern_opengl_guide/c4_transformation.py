...
uni_trans = glGetUniformLocation(shader_program, b"trans")

def update(dt):
    tm = time.time() - start_time
    trans = euclid.Matrix4()
    trans.rotatez(tm * math.radians(180))
    trans = trans[:]

    glUniformMatrix4fv(uni_trans, 1, GL_FALSE, (GLfloat * 16)(*trans))
