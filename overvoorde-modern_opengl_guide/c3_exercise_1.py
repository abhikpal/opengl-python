...
fragment_source = b"""
    ...
    void main()
    {
        ...
        outColor = mix(texture(texPuppy, Texcoord), texture(texKitten, Texcoord), factor);
    }
"""
...
time_uniform = glGetUniformLocation(shader_program, b"time")


def update(dt):
    elapsed = time.time() - start_time
    glUniform1f(time_uniform, elapsed)
