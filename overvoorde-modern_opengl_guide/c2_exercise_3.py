...
glVertexAttribPointer(pos_attrib, 2, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat(1)), 0)

col_attrib = glGetAttribLocation(shader_program, b"color")
glEnableVertexAttribArray(col_attrib)
glVertexAttribPointer(col_attrib, 1, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat(1)), 2*sizeof(GLfloat(1)))
